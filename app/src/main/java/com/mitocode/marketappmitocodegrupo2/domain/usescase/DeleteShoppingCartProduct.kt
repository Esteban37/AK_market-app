...
class DeleteShoppingCartProduct @Inject
constructor(private val shoppingCartRepoitory: ShoppingCartRepository) {

    suspend operator fun invoke(shoppingCart: ShoppingCart) = shoppingCartRepoitory.deleteProductShoppingCart(shoppingCart)
